...
| **T2** CosyVoice 配音 | 9 | **8**（**T2.1 ✅ T2.2 ✅** **T2.4 ✅** T2.5 ✅ T2.6 ✅ T2.7 ✅ T2.8 ✅ T2.9 ✅）+ **1 部分**（T2.3 🔶） | M2 | [ ] |
...
> **当前关键路径**：`T2.1 ✅` ⇒ `T2.2 ✅` ⇒ `T2.3 🔶`（**管子已通**，剩熔断与决策表）⇒ **`T2.4` 正式原声**（试听样本已补，2026-09-19）⇒ `T3.3`（🔶 只差语法预检 / 节点守卫 / `render plan` 三个非核心子项）。**T3.4–T3.7 与 T4 / T5 都已收口**；一期剩下的只有 T2.3 这条 🔶、T2.4 的正式原声与 T3.1 / T3.3 的非核心缺项。
